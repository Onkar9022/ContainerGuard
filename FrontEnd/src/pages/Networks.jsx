  ...
  return (
    <div className="space-y-5">
      ...
      <div className="rounded-xl border border-border-primary bg-bg-surface overflow-hidden">
        <div className="grid grid-cols-[1fr_120px_120px_100px_80px] gap-3 items-center px-5 py-3 text-[10px] font-semibold uppercase tracking-wider text-text-muted border-b border-border-primary">
        ...
        <EmptyState
          ...
          message="Docker network information will be available after Docker Engine integration in Phase 4."
        />
